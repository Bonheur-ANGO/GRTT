...
<link href="http://localhost/GRTT/public/css/progress.css" rel="stylesheet">
...
<div class="container">
    ...
    <form method="POST" class="headings">
        ...
        <a href="" style="border-bottom: 5px solid red;">En cours</a>
        <a href="complaints_processed">Traitées</a>
    </form><br><br><br>

    <form method="POST" class="bloc_filter" action="">
        <p>Filtre:</p>
        <button type="submit" name="progress_type_1">Téléphonie Fixe</button>
        <button type="submit" name="progress_type_2">Téléphonie Mobile</button>
        <button type="submit" name="progress_type_3">Internet, ADSL, 3G</button>
        <button type="submit" name="progress_type_4">4G</button>
    </form>
